...
export function DocumentsPage() {
  ...
  const getCategoryColor = (category: string) => {
    ...
    if (category.includes("Legal")) return "text-muted-foreground bg-muted";
  ...
  const getStatusColor = (status: string) => {
    ...
    if (status === "Draft") return "text-gray-600 bg-gray-50 border-border";
      ...
      <PageContainer>
        <div className="flex flex-col space-y-6 max-w-7xl mx-auto pb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-card p-5 rounded-xl border shadow-sm relative overflow-hidden flex flex-col justify-between">
              <div>
          ...
          <div className="bg-card rounded-xl border shadow-sm overflow-hidden mt-6">
            <div className="p-4 flex items-center justify-between gap-4 border-b">
              <div className="flex items-center gap-4 flex-1">
                ...
                <select className="h-10 rounded-md border border-border bg-card px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
              ...
              <Button variant="outline" className="text-gray-600 border-border">
            ...
            <form onSubmit={handleUploadSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full h-10 rounded-md border border-border bg-card px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500" value={uploadData.category} onChange={e => setUploadData({...uploadData, category: e.target.value})}>
                    <option>Personal Documents</option>
                    <option>Legal Documents</option>
                    <option>Financial Documents</option>
                ...
                <div>
                  ...
                  <select className="w-full h-10 rounded-md border border-border bg-card px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500" value={uploadData.status} onChange={e => setUploadData({...uploadData, status: e.target.value})}>
                    <option>Draft</option>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-border rounded-lg p-6 flex flex-col items-center justify-center bg-gray-50">
