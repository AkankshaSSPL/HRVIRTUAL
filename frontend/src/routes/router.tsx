...
export const router = createBrowserRouter([
  ...
  { path: "/offer-response/:offerId", element: <OfferResponsePage /> },
  ...
  { element: <ProtectedRoute permission="dashboard:view" />, children: [{ path: "/attendance", element: <AttendancePage /> }] },
  { element: <ProtectedRoute permission="dashboard:view" />, children: [{ path: "/calendar", element: <CalendarPage /> }] },
  { element: <ProtectedRoute permission="dashboard:view" />, children: [{ path: "/my-allocations", element: <MyAllocationsPage /> }] },
  { element: <ProtectedRoute permission="dashboard:view" />, children: [{ path: "/my-records", element: <MyRecordsPage /> }] },
  { element: <ProtectedRoute permission="dashboard:view" />, children: [{ path: "/my-documents", element: <MyDocumentsPage /> }] },
  { element: <ProtectedRoute permission="leave:view" />, children: [{ path: "/leave", element: <LeavePage /> }] },
  { element: <ProtectedRoute permission="dashboard:view" />, children: [{ path: "/payroll", element: <PayrollPage /> }] },
  { element: <ProtectedRoute permission="documents:view" />, children: [{ path: "/documents", element: <DocumentsPage /> }] },
  { element: <ProtectedRoute permission="knowledge:chat" />, children: [{ path: "/knowledge", element: <KnowledgePage /> }] },
  { element: <ProtectedRoute permission="assets:view" />, children: [{ path: "/assets", element: <AssetsPage /> }] },
  { element: <ProtectedRoute permission="offboarding:view" />, children: [{ path: "/offboarding", element: <OffboardingPage /> }] },
